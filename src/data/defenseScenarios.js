const defenseScenarios = {
  ...
  helpRecover: {
    ...
    diagram: {
      ballHandler: { x: 250, y: 230, label: 'PG' },
      defenderBeaten: { x: 230, y: 190, label: 'Beat!' },
      helpDefender: { x: 190, y: 160, label: 'You' },
      helpDefenderMan: { x: 130, y: 130, label: 'Your Man' },
      helpPath: { from: { x: 190, y: 160 }, mid: { x: 220, y: 200 }, to: { x: 260, y: 220 }, label: 'help' },
      recoverPath: { from: { x: 260, y: 220 }, to: { x: 180, y: 140 }, label: 'recover' },
      basket: { x: 250, y: 30 },
    },
  },
  ...
  boxOut: {
    ...
    diagram: {
      shooter: { x: 200, y: 160, label: 'Shooter' },
      defenderYou: { x: 250, y: 220, label: 'You' },
      opponent: { x: 270, y: 240, label: 'Opponent' },
      basket: { x: 250, y: 30 },
      ballArc: { start: { x: 200, y: 160 }, peak: { x: 250, y: 60 }, end: { x: 250, y: 35 } },
    },
  },
};
