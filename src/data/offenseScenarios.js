const offenseScenarios = {
  tripleThreat: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 530, label: 'You' },
      teammate1: { x: 300, y: 570, label: 'SG' },
      teammate2: { x: 140, y: 580, label: 'PG' },
      teammate3: { x: 380, y: 600, label: 'SF' },
      defender1: { x: 200, y: 490, label: 'D' },
      defender2: { x: 260, y: 540, label: 'D' },
      defender3: { x: 320, y: 510, label: 'D' },
      saggingArrow: { from: { x: 200, y: 505 }, to: { x: 200, y: 525 }, label: '3ft gap' },
    },
  },
  ...
  fastbreak: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 600, label: 'You' },
      teammate1: { x: 100, y: 460, label: 'Teammate' },
      defender1: { x: 200, y: 520, label: 'D' },
      pathArrow: { from: { x: 200, y: 600 }, to: { x: 200, y: 530 }, label: 'drive' },
      passArrow: { from: { x: 200, y: 530 }, to: { x: 120, y: 460 }, label: 'pass' },
    },
  },
  ...
  spacing: {
    ...
    diagram: {
      positions: [
        { id: 'player1', x: 250, y: 520, label: 'You', draggable: true, startX: 250, startY: 520, targetX: 100, targetY: 480 },
        { id: 'player2', x: 280, y: 540, label: 'PG', draggable: false },
        { id: 'player3', x: 230, y: 560, label: 'SF', draggable: false },
        { id: 'player4', x: 310, y: 500, label: 'SG', draggable: false },
        { id: 'def1', x: 270, y: 530, label: 'D', draggable: false, defender: true },
        { id: 'def2', x: 300, y: 550, label: 'D', draggable: false, defender: true },
      ],
      targetZone: { x: 90, y: 470, width: 60, height: 60 },
    },
  },
};
...
const NEW_OFFENSE_SCENARIOS = {
  pickAndRoll: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 550, label: 'You' },
      teammate1: { x: 200, y: 470, label: 'C/Roller' },
      teammate2: { x: 300, y: 560, label: 'SG' },
      defender1: { x: 200, y: 510, label: 'D (under)' },
      defender2: { x: 200, y: 460, label: 'Help' },
    },
  },
  ...
  giveAndGo: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 550, label: 'You' },
      teammate1: { x: 300, y: 540, label: 'PG' },
      defender1: { x: 200, y: 490, label: 'D' },
      defender2: { x: 300, y: 500, label: 'D' },
    },
  },
  ...
  postUp: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 500, label: 'You' },
      teammate1: { x: 300, y: 560, label: 'PG' },
      teammate2: { x: 120, y: 550, label: 'SF' },
      defender1: { x: 200, y: 460, label: 'D' },
      defender2: { x: 260, y: 480, label: 'Help' },
      defender3: { x: 180, y: 480, label: 'Doubler' },
    },
  },
  ...
  isolation: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 550, label: 'You' },
      teammate1: { x: 300, y: 570, label: 'SG' },
      teammate2: { x: 120, y: 560, label: 'PG' },
      defender1: { x: 200, y: 500, label: 'D' },
    },
  },
  ...
  backdoor: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 570, label: 'PG' },
      teammate1: { x: 300, y: 530, label: 'You' },
      defender1: { x: 300, y: 490, label: 'D (overplay)' },
    },
  },
};
