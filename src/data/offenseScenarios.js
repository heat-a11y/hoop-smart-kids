const offenseScenarios = {
  tripleThreat: {
    ...
    diagram: {
      ballHandler: { x: 200, y: 160, label: 'You' },
      teammate1: { x: 300, y: 200, label: 'SG' },
      teammate2: { x: 140, y: 240, label: 'PG' },
      teammate3: { x: 380, y: 280, label: 'SF' },
      defender1: { x: 200, y: 200, label: 'D' },
      defender2: { x: 260, y: 260, label: 'D' },
      defender3: { x: 320, y: 180, label: 'D' },
      saggingArrow: { from: { x: 200, y: 175 }, to: { x: 200, y: 195 }, label: '3ft gap' },
    },
  },
